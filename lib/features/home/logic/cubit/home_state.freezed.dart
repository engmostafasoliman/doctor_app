...
return specializationError(_that.errorHandler);case DoctorsLoaded() when doctorsLoaded != null:
...
return specializationError(_that.errorHandler);case DoctorsLoaded():
